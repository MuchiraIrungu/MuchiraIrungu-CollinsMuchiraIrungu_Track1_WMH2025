...
var DEMInstanceTypeOrthorectification;
...
})(DEMInstanceTypeOrthorectification || (DEMInstanceTypeOrthorectification = {}));
var BYOCSubTypes;
(function (BYOCSubTypes) {
    BYOCSubTypes["BATCH"] = "BATCH";
    BYOCSubTypes["BYOC"] = "BYOC";
    BYOCSubTypes["ZARR"] = "ZARR";
})(BYOCSubTypes || (BYOCSubTypes = {}));
var OgcServiceTypes;
...
const SUPPORTED_TARGETS = [CacheTarget.CACHE_API, CacheTarget.MEMORY];
...
function createGetCapabilitiesXmlUrl(baseUrl, ogcServiceType) {
    ...
    return stringifyUrl({ url: url, query: Object.assign(Object.assign({}, defaultQueryParams), query) }, { sort: false });
}
            ...
            return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (let x = 0; x < width; x += chunkWidth) {
                    ...
                    for (let y = 0; y < height; y += chunkHeight) {
                        ...
                        const paramsChunk = Object.assign(Object.assign({}, params), { width: xTo - x, height: yTo - y, bbox: new BBox(bbox.crs, xToLng(x), yToLat(yTo), xToLng(xTo), yToLat(y)), preview: PreviewMode.EXTENDED_PREVIEW });
...
class AbstractSentinelHubV3Layer extends AbstractLayer {
    ...
    getStats(params_1) {
        return __awaiter(this, arguments, void 0, function* (params, reqConfig = {}, statsProvider = StatisticsProviderType.FIS) {
...
class S1GRDAWSEULayer extends AbstractSentinelHubV3Layer {
    constructor({ instanceId = null, layerId = null, evalscript = null, evalscriptUrl = null, dataProduct = null, title = null, description = null, legendUrl = null, acquisitionMode = null, polarization = null, resolution = null, orthorectify = null, demInstanceType = null, backscatterCoeff = BackscatterCoeff.GAMMA0_ELLIPSOID, orbitDirection = null, speckleFilter = null, mosaickingOrder = null, highlights = null, }) {
        ...
        this.backscatterCoeff = BackscatterCoeff.GAMMA0_ELLIPSOID;
...
})(S3SLSTRView || (S3SLSTRView = {}));
class S3SLSTRLayer extends AbstractSentinelHubV3WithCCLayer {
    constructor(_a) {
        var { view = S3SLSTRView.NADIR } = _a, rest = __rest(_a, ["view"]);
        super(rest);
...
function legacyGetMapFromUrl(urlWithQueryParams_1) {
    return __awaiter(this, arguments, void 0, function* (urlWithQueryParams, api = ApiType.WMS, fallbackToWmsApi = false, overrideLayerConstructorParams, overrideGetMapParams) {
...
function legacyGetMapFromParams(baseUrl_1, wmsParams_1) {
    return __awaiter(this, arguments, void 0, function* (baseUrl, wmsParams, api = ApiType.WMS, fallbackToWmsApi = false, overrideLayerConstructorParams, overrideGetMapParams, requestConfig, preferGetCapabilities = true) {
            ...
            case ApiType.PROCESSING:
                try {
                    ...
                    if (fallbackToWmsApi) {
                        ...
                        return legacyGetMapFromParams(baseUrl, wmsParams, ApiType.WMS, fallbackToWmsApi, overrideLayerConstructorParams, overrideGetMapParams);
                    }
                    else {
                        throw ex;
                    }
...
})(TPDICollections || (TPDICollections = {}));
var TPDProvider;
...
})(MaxarSensor || (MaxarSensor = {}));
var PlanetProductBundle;
...
})(PlanetProductBundle || (PlanetProductBundle = {}));
var PlanetItemType;
...
const PlanetSupportedPVIds = {
    ...
    [PlanetPVType.SoilWaterContent]: [
        ...
        PlanetPVId.SWC_AMSRE_C_V5_0_1000,
        PlanetPVId.SWC_AMSRE_X_V5_0_1000,
        PlanetPVId.SWC_AMSR2_C_V5_0_1000,
        PlanetPVId.SWC_AMSR2_X_V5_0_1000,
        PlanetPVId.SWC_SMAP_L_V5_0_1000,
    ],
...
})(TPDITransactionStatus || (TPDITransactionStatus = {}));
var PlanetScopeHarmonization;
...
})(PlanetScopeHarmonization || (PlanetScopeHarmonization = {}));
var ResamplingKernel;
...
export { AcquisitionMode, AirbusConstellation, AirbusProcessingLevel, ApiType, BBox, BYOCLayer, BYOCSubTypes, BackscatterCoeff, CRS_EPSG3857, CRS_EPSG4326, CRS_WGS84, CacheTarget, CancelToken, DATASET_AWSEU_S1GRD, DATASET_AWSUS_DEM, DATASET_AWS_DEM, DATASET_AWS_HLS, DATASET_AWS_L8L1C, DATASET_AWS_LETML1, DATASET_AWS_LETML2, DATASET_AWS_LMSSL1, DATASET_AWS_LOTL1, DATASET_AWS_LOTL2, DATASET_AWS_LTML1, DATASET_AWS_LTML2, DATASET_BYOC, DATASET_CDAS_DEM, DATASET_CDAS_S1GRD, DATASET_CDAS_S2L1C, DATASET_CDAS_S2L2A, DATASET_CDAS_S3OLCI, DATASET_CDAS_S3OLCIL2, DATASET_CDAS_S3SLSTR, DATASET_CDAS_S3SYNERGYL2, DATASET_CDAS_S5PL2, DATASET_MODIS, DATASET_S2L1C, DATASET_S2L2A, DATASET_S3OLCI, DATASET_S3SLSTR, DATASET_S5PL2, DEMAWSUSLayer, DEMCDASLayer, DEMInstanceType, DEMInstanceTypeOrthorectification, DEMLayer, Fis, HLSAWSLayer, HLSConstellation, Interpolator, Landsat15AWSLMSSL1Layer, Landsat45AWSLTML1Layer, Landsat45AWSLTML2Layer, Landsat7AWSLETML1Layer, Landsat7AWSLETML2Layer, Landsat8AWSLOTL1Layer, Landsat8AWSLOTL2Layer, Landsat8AWSLayer, LayersFactory, LinkType, LocationIdSHv3, MODISLayer, MaxarSensor, MimeTypes, MosaickingOrder, OrbitDirection, PlanetARPSId, PlanetARPSType, PlanetItemType, PlanetNicfiLayer, PlanetPVId, PlanetPVType, PlanetProductBundle, PlanetScopeHarmonization, PlanetSupportedPVIds, PlanetSupportedProductBundles, Polarization, PreviewMode, ProcessingDataFusionLayer, ResamplingKernel, Resolution, S1GRDAWSEULayer, S1GRDCDASLayer, S2L1CCDASLayer, S2L1CLayer, S2L2ACDASLayer, S2L2ALayer, S3OLCICDASLayer, S3OLCIL2CDASLayer, S3OLCILayer, S3SLSTRCDASLayer, S3SLSTRLayer, S3SLSTRView, S3SYNL2CDASLayer, S5PL2CDASLayer, S5PL2Layer, SHV3_LOCATIONS_ROOT_URL, SUPPORTED_CRS_OBJ, SpeckleFilterType, StatisticalApi, StatisticsProviderType, StatisticsUtils, TPDI, TPDICollections, TPDITransactionStatus, TPDProvider, WmsLayer, WmtsLayer, wmsGetMapUrl as _wmsGetMapUrl, addAxiosRequestInterceptor, addAxiosResponseInterceptor, canvasToBlob, drawBlobOnCanvas, getStatisticsProvider, invalidateCaches, isAuthTokenSet, isCancelled, legacyGetMapFromParams, legacyGetMapFromUrl, legacyGetMapWmsUrlFromParams, parseLegacyWmsGetMapParams, registerHostnameReplacing, requestAuthToken, setAuthToken, setDebugEnabled, setDefaultRequestsConfig, setTPDIServiceBaseURL };
