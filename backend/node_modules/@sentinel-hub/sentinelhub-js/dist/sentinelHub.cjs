...
(function (PreviewMode) {
    ...
    PreviewMode[PreviewMode["EXTENDED_PREVIEW_UNOFFICIAL"] = 3] = "EXTENDED_PREVIEW_UNOFFICIAL";
})(exports.PreviewMode || (exports.PreviewMode = {}));
exports.MosaickingOrder = void 0;
...
exports.BackscatterCoeff = void 0;
...
(function (LocationIdSHv3) {
    ...
    LocationIdSHv3["cdse"] = "cdse";
    LocationIdSHv3["cdseOtc"] = "cdse-otc";
...
const SHV3_LOCATIONS_ROOT_URL = {
    ...
    [exports.LocationIdSHv3.gcpUsCentral1]: 'https://services-gcp.sentinel-hub.com/',
    [exports.LocationIdSHv3.cdse]: 'https://sh.dataspace.copernicus.eu/',
    [exports.LocationIdSHv3.cdseOtc]: 'https://sh-otc.dataspace.copernicus.eu/',
};
const SH_SERVICE_ROOT_URL = {
    default: SHV3_LOCATIONS_ROOT_URL[exports.LocationIdSHv3.awsEuCentral1],
    cdse: SHV3_LOCATIONS_ROOT_URL[exports.LocationIdSHv3.cdse],
    cdseOtc: SHV3_LOCATIONS_ROOT_URL[exports.LocationIdSHv3.cdseOtc],
};
var HistogramType;
...
exports.DEMInstanceType = void 0;
...
exports.DEMInstanceTypeOrthorectification = void 0;
...
const XmlParserOptions = Object.freeze({
    attributesGroupName: '$',
    attributeNamePrefix: '',
    textNodeName: '_',
...
const xmlParser = new fastXmlParser.XMLParser(XmlParserOptions);
function isWMSCapabilities(capabilitiesXml) {
    return capabilitiesXml.WMS_Capabilities !== undefined;
}
...
function fetchLayersFromGetCapabilitiesXml(baseUrl, ogcServiceType, reqConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const layersInfos = _flattenLayers(capabilities === null || capabilities === void 0 ? void 0 : capabilities.Capability[0].Layer).filter((layerInfo) => layerInfo.Name);
        return layersInfos;
    });
}
...
function getSHServiceRootUrl(host) {
...
function getSHServiceRootUrlFromBaseUrl(baseUrl) {
    let host = baseUrl;
...
function fetchLayerParamsFromConfigurationService(_a) {
    return __awaiter(this, arguments, void 0, function* ({ shServiceHostName, instanceId, includeHighlights, reqConfig, }) {
        ...
        const configurationServiceHostName = shServiceHostName !== null && shServiceHostName !== void 0 ? shServiceHostName : SH_SERVICE_ROOT_URL.default;
        ...
        const res = yield axios.get(url.toString(), requestConfig);
        const resData = typeof res.data === 'string' ? JSON.parse(res.data) : res.data;
        const layersParams = resData.map((l) => {
            var _a, _b, _c;
            const defaultStyle = (_a = l.styles.find((s) => s.name === l.defaultStyleName)) !== null && _a !== void 0 ? _a : l.styles[0];
            return Object.assign(Object.assign(Object.assign({ layerId: l.id, title: l.title, description: l.description }, l.datasourceDefaults), (((_b = l.datasourceDefaults) === null || _b === void 0 ? void 0 : _b.maxCloudCoverage) !== undefined && {
                maxCloudCoverPercent: l.datasourceDefaults.maxCloudCoverage,
            })), { evalscript: defaultStyle.evalScript, dataProduct: defaultStyle.dataProductId
                    ? `${configurationServiceHostName}api/v2/configuration/datasets/${l.collectionType}/dataproducts/${defaultStyle.dataProductId}`
                    : undefined, legend: defaultStyle ? defaultStyle.legend : null, highlights: (_c = l.highlights) === null || _c === void 0 ? void 0 : _c.member });
        });
        return layersParams;
    });
}
function fetchDataProduct(url, reqConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const authToken = reqConfig && reqConfig.authToken ? reqConfig.authToken : getAuthToken();
        if (!authToken) {
            throw new Error('Must be authenticated to fetch layer params');
        ...
        const requestConfig = Object.assign({ responseType: 'json', headers: headers }, getAxiosReqParams(Object.assign(Object.assign({}, reqConfig), { 
            // Do not override cache if cache is disabled with `expiresIn: 0`
            cache: reqConfig && reqConfig.cache && reqConfig.cache.expiresIn === 0
                ? reqConfig.cache
                : CACHE_CONFIG_30MIN_MEMORY }), null));
...
function metersPerPixel(bbox, width) {
...
const DATASET_CDAS_OTC_S3SLSTR = {
    id: 'CDAS_S3SLSTR',
    shJsonGetCapabilitiesDataset: 'S3SLSTR',
    shWmsEvalsource: 'S3SLSTR',
    shProcessingApiDatasourceAbbreviation: 'S3SLSTR',
...
const DATASET_CDAS_S3SYNERGYL2 = {
    id: 'CDAS_S3SYNL2',
...
const DATASET_CDAS_OTC_S3OLCIL2 = {
    id: 'CDAS_S3OLCIL2',
    shJsonGetCapabilitiesDataset: 'S3OLCIL2',
    shWmsEvalsource: 'sentinel-3-olci-l2',
    shProcessingApiDatasourceAbbreviation: 'sentinel-3-olci-l2',
...
function wmsGetMapUrl(baseUrl, layers, params, evalscript = null, evalscriptUrl = null, evalsource = null, additionalParameters = {}) {
    const queryParams = getQueryParams(baseUrl, layers, params, evalscript, evalscriptUrl, evalsource, additionalParameters);
    return createUrl(baseUrl, queryParams, params);
}
function wmsWmtMsGetMapUrl(baseUrl, layers, params, evalscript = null, evalscriptUrl = null, evalsource = null, additionalParameters = {}) {
    let queryParams = getQueryParams(baseUrl, layers, params, evalscript, evalscriptUrl, evalsource, additionalParameters);
    const bbox = ensureMercatorBBox(params.bbox);
    ...
    if (!params.fromTime) {
        ...
        queryParams.time = `${moment.utc(params.fromTime).format('YYYY-MM-DDTHH:mm:ss') + 'Z'}/${moment.utc(params.toTime).format('YYYY-MM-DDTHH:mm:ss') + 'Z'}`;
    }
...
function getQueryParams(baseUrl, layers, params, evalscript = null, evalscriptUrl = null, evalsource = null, additionalParameters = {}) {
...
function createUrl(baseUrl, queryParams, params) {
...
function drawBlobOnCanvas(ctx_1, blob_1) {
    return __awaiter(this, arguments, void 0, function* (ctx, blob, dx = 0, dy = 0, dWidth, dHeight) {
        ...
        try {
            ...
            const width = dWidth !== null && dWidth !== void 0 ? dWidth : imgDrawn.naturalWidth;
            const height = dHeight !== null && dHeight !== void 0 ? dHeight : imgDrawn.naturalHeight;
...
class AbstractLayer {
    ...
    getHugeMap(params, api, reqConfig, evalScriptId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                const outputFormat = (params.format === MimeTypes.JPEG_OR_PNG ? MimeTypes.PNG : params.format);
    ...
    findTilesInner(bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (bbox, // eslint-disable-line @typescript-eslint/no-unused-vars
    ...
    findTiles(bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (bbox, // eslint-disable-line @typescript-eslint/no-unused-vars
        fromTime, // eslint-disable-line @typescript-eslint/no-unused-vars
        toTime, // eslint-disable-line @typescript-eslint/no-unused-vars
        maxCount = null, // eslint-disable-line @typescript-eslint/no-unused-vars
    ...
    findFlyovers(bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (bbox, fromTime, toTime, maxFindTilesRequests = 50, tilesPerRequest = 50, reqConfig, overrideOrbitTimeMinutes = null) {
            ...
            data: [
                {
                    dataFilter: {
                        timeRange: {
                            from: (_b = params.fromTime) === null || _b === void 0 ? void 0 : _b.toISOString(),
                            to: (_c = params.toTime) === null || _c === void 0 ? void 0 : _c.toISOString(),
                        },
...
function processingGetMap(shServiceHostname, payload, reqConfig, useV2) {
    return __awaiter(this, void 0, void 0, function* () {
        const authToken = reqConfig && reqConfig.authToken ? reqConfig.authToken : getAuthToken();
        if (!authToken) {
        ...
        const response = yield axios.post(`${shServiceHostname}api/${useV2 ? 'v2' : 'v1'}/process`, payload, requestConfig);
        return response.data;
    });
}

exports.StatisticsProviderType = void 0;
...
class Fis {
    createFISPayload(layer, params) {
        ...
        const payload = Object.assign({ layer: layer.getLayerId(), crs: params.crs ? params.crs.authId : CRS_EPSG4326.authId, geometry: WKT.convert(params.geometry), time: `${moment.utc(params.fromTime).format('YYYY-MM-DDTHH:mm:ss') + 'Z'}/${moment.utc(params.toTime).format('YYYY-MM-DDTHH:mm:ss') + 'Z'}`, resolution: undefined, bins: params.bins || 5, type: HistogramType.EQUALFREQUENCY }, layer.getStatsAdditionalParameters());
    ...
    getStats(layer, _params, reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
...
class AbstractSentinelHubV3Layer extends AbstractLayer {
    constructor({ instanceId = null, layerId = null, evalscript = null, evalscriptUrl = null, dataProduct = null, mosaickingOrder = null, title = null, description = null, upsampling = null, downsampling = null, legendUrl = null, highlights = null, }) {
        super({ title, description, legendUrl });
    ...
    fetchLayerParamsFromSHServiceV3(reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const layersParams = yield fetchLayerParamsFromConfigurationService({
            ...
            if (!layerParams['evalscript'] &&
                ...
                const response = yield fetchDataProduct(layerParams['dataProduct'], reqConfig);
                const evalScript = (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.evalScript;
                if (evalScript) {
    ...
    _updateProcessingGetMapPayload(payload_1) {
        return __awaiter(this, arguments, void 0, function* (payload, datasetSeqNo = 0, // eslint-disable-line @typescript-eslint/no-unused-vars
        reqConfig, // eslint-disable-line @typescript-eslint/no-unused-vars
        params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (api === exports.ApiType.PROCESSING) {
                    ...
                    const payload = createProcessingPayload(this.dataset, params, (_a = params.evalscriptId) !== null && _a !== void 0 ? _a : this.evalscript, this.dataProduct, this.mosaickingOrder, this.upsampling, this.downsampling);
                    // allow subclasses to update payload with their own parameters:
                    const updatedPayload = yield this._updateProcessingGetMapPayload(payload, 0, innerReqConfig, params);
                    const shServiceHostname = this.getShServiceHostname();
                    let blob = yield processingGetMap(shServiceHostname, updatedPayload, innerReqConfig, Boolean(params.evalscriptId));
                    // apply effects:
                    // support deprecated GetMapParams.gain and .gamma parameters
                    // but override them if they are also present in .effects
                    const effects = Object.assign({ gain: params.gain, gamma: params.gamma }, params.effects);
    ...
    supportsApiType(api) {
        ...
        return api === exports.ApiType.WMS || (api === exports.ApiType.PROCESSING && !!this.dataset && !!this.evalscript);
    }
    ...
    findTilesInner(bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (bbox, fromTime, toTime, maxCount = null, offset = null, reqConfig, intersects) {
            const authToken = reqConfig && reqConfig.authToken ? reqConfig.authToken : getAuthToken();
    ...
    findTilesUsingCatalog(authToken_1, bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (authToken, bbox, fromTime, toTime, maxCount = null, offset = null, reqConfig, findTilesAdditionalParameters, intersects) {
    ...
    getStats(params_1) {
        return __awaiter(this, arguments, void 0, function* (params, reqConfig = {}, statsProvider = exports.StatisticsProviderType.FIS) {
            const stats = yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                let data;
                if (statsProvider === exports.StatisticsProviderType.FIS) {
                    data = yield new Fis().handleV3(this, params, innerReqConfig);
                }
                else if (statsProvider === exports.StatisticsProviderType.STAPI) {
                    data = yield new StatisticalApi().getStats(this, params, innerReqConfig);
                }
                else {
...
exports.SpeckleFilterType = void 0;
...
class S1GRDAWSEULayer extends AbstractSentinelHubV3Layer {
    ...
    _updateProcessingGetMapPayload(payload_1) {
        return __awaiter(this, arguments, void 0, function* (payload, datasetSeqNo = 0, reqConfig) {
...
class AbstractSentinelHubV3WithCCLayer extends AbstractSentinelHubV3Layer {
    ...
    _updateProcessingGetMapPayload(payload_1) {
        ...
        return __awaiter(this, arguments, void 0, function* (payload, datasetSeqNo = 0) {
...
class S2L2ALayer extends AbstractSentinelHubV3WithCCLayer {
    ...
    extractFindTilesMeta(tile) {
        return Object.assign(Object.assign({}, super.extractFindTilesMeta(tile)), { tileId: tile.id, MGRSLocation: tile.dataUri.split('/').slice(4, 7).join('') });
    }
    extractFindTilesMetaFromCatalog(feature) {
...
class S5PL2Layer extends AbstractSentinelHubV3Layer {
    constructor({ instanceId = null, layerId = null, evalscript = null, evalscriptUrl = null, dataProduct = null, title = null, description = null, legendUrl = null, productType = null, maxCloudCoverPercent = 100, minQa = null, highlights = null, }) {
        super({
            instanceId,
            layerId,
            evalscript,
...
class AbstractDEMLayer extends AbstractSentinelHubV3Layer {
    ...
    findTiles(bbox_1, fromTime_1, toTime_1) {
        return __awaiter(this, arguments, void 0, function* (bbox, fromTime, // eslint-disable-line @typescript-eslint/no-unused-vars
...
class DEMCDASLayer extends AbstractDEMLayer {
    constructor(_a) {
        var { demInstance } = _a, rest = __rest(_a, ["demInstance"]);
        super(rest);
        this.dataset = DATASET_CDAS_DEM;
        if (demInstance === exports.DEMInstanceType.MAPZEN) {
...
class BYOCLayer extends AbstractSentinelHubV3Layer {
    constructor({ instanceId = null, layerId = null, evalscript = null, evalscriptUrl = null, dataProduct = null, title = null, description = null, collectionId = null, locationId = null, subType = null, shServiceRootUrl = SH_SERVICE_ROOT_URL.default, highlights = null, }) {
            ...
            yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.locationId === null) {
                    if (this.subType !== exports.BYOCSubTypes.ZARR) {
                        ...
                        this.locationId = (_a = res.data.data.find((item) => item.id === this.collectionId)) === null || _a === void 0 ? void 0 : _a.location;
                    }
                    else {
    ...
    _updateProcessingGetMapPayload(payload_1) {
        return __awaiter(this, arguments, void 0, function* (payload, datasetSeqNo = 0, reqConfig, params) {
            yield this.updateLayerFromServiceIfNeeded(reqConfig);
            if (this.shouldUseLowResolutionCollection(params === null || params === void 0 ? void 0 : params.bbox, payload.output.width)) {
    ...
    shouldUseLowResolutionCollection(bbox, width) {
        return (this.lowResolutionCollectionId !== undefined &&
    ...
    getAvailableBands(reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            const bandsResponseData = yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                const commonReqConfig = Object.assign({ responseType: 'json', headers: { Authorization: `Bearer ${getAuthToken()}` } }, getAxiosReqParams(innerReqConfig, CACHE_CONFIG_30MIN));
                const metadataUrl = `${this.getSHServiceRootUrl()}api/v1/catalog/1.0.0/collections/${this.getTypeId()}`;
                const metadataRes = yield axios.get(metadataUrl, commonReqConfig);
                const metadataBands = (_a = metadataRes.data.summaries['eo:bands']) === null || _a === void 0 ? void 0 : _a.map(({ name }, index) => {
                    var _a;
                    return {
                        name,
                        sampleType: (_a = metadataRes.data.summaries['raster:bands']) === null || _a === void 0 ? void 0 : _a[index].data_type.toUpperCase(),
                    };
                });
...
class S3OLCICDASLayer extends S3OLCILayer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_S3OLCI;
    }
}

class S3SLSTRCDASLayer extends S3SLSTRLayer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_S3SLSTR;
    }
}

class S5PL2CDASLayer extends S5PL2Layer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_S5PL2;
    }
}

class WmsWmtMsLayer extends WmsLayer {
    getMapUrl(params, api) {
        if (api !== exports.ApiType.WMS) {
            throw new Error('Only WMS is supported on this layer');
        }
...
class S3OLCIL2CDASLayer extends AbstractSentinelHubV3WithCCLayer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_S3OLCIL2;
    }
    convertResponseFromSearchIndex(response) {
        return {
            tiles: response.data.tiles.map((tile) => ({
...
class S3SYNL2CDASLayer extends AbstractSentinelHubV3WithCCLayer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_S3SYNERGYL2;
    }
    convertResponseFromSearchIndex(response) {
        return {
            tiles: response.data.tiles.map((tile) => ({
...
class LayersFactory {
    ...
    static makeLayer(baseUrl_1, layerId_1, overrideConstructorParams_1, reqConfig_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, layerId, overrideConstructorParams, reqConfig, preferGetCapabilities = true) {
    ...
    static makeLayers(baseUrl_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, filterLayers = null, overrideConstructorParams, reqConfig, preferGetCapabilities = true, includeHighlights = false) {
            const returnValue = yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                for (let hostname of SH_SERVICE_HOSTNAMES_V3) {
                    if (baseUrl.startsWith(hostname)) {
                        return yield this.makeLayersSHv3(baseUrl, filterLayers, overrideConstructorParams, innerReqConfig, preferGetCapabilities, includeHighlights);
                    }
                }
    ...
    static makeLayersSHv3(baseUrl_1, filterLayers_1, overrideConstructorParams_1, reqConfig_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, filterLayers, overrideConstructorParams, reqConfig, preferGetCapabilities = true, includeHighlights = false) {
            const filteredLayersInfos = yield this.getSHv3LayersInfo(baseUrl, reqConfig, filterLayers, preferGetCapabilities, includeHighlights);
            return filteredLayersInfos.map((_a) => {
                ...
                return new SHLayerClass(Object.assign(Object.assign(Object.assign({ instanceId: parseSHInstanceId(baseUrl), layerId, evalscript: evalscript || null, evalscriptUrl: null, dataProduct: dataProduct || null, title,
                    description,
                    legendUrl }, rest), overrideConstructorParams), { shServiceRootUrl: shServiceRootUrl }));
            });
        });
    }
    static getSHv3LayersInfo(baseUrl_1, reqConfig_1, filterLayers_1) {
        return __awaiter(this, arguments, void 0, function* (baseUrl, reqConfig, filterLayers, preferGetCapabilities = true, includeHighlights = false) {
            let layersInfos;
            ...
            if (authToken && preferGetCapabilities === false) {
                try {
                    const layers = yield fetchLayerParamsFromConfigurationService({
    ...
    overrideConstructorParams, reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filteredLayersInfos = filterLayers === null ? layersInfos : layersInfos.filter((l) => filterLayers(l.layerId, l.dataset));
            const parsedXml = (yield fetchGetCapabilitiesXml(baseUrl, OgcServiceTypes.WMS, reqConfig));
...
class ProcessingDataFusionLayer extends AbstractSentinelHubV3Layer {
    constructor({ title = null, description = null, evalscript = null, evalscriptUrl = null, layers, highlights = null, }) {
    ...
    getMap(params, api, reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.layers.every((layer) => layer.layer.getShServiceHostname() === bogusFirstLayer.getShServiceHostname())) {
                    shServiceHostname = bogusFirstLayer.getShServiceHostname();
                }
                //check if all layers use same root url and use it for request
                else if (this.layers.every((layer) => layer.layer.getSHServiceRootUrl() === bogusFirstLayer.getSHServiceRootUrl())) {
...
function legacyGetMapFromUrl(urlWithQueryParams_1) {
    return __awaiter(this, arguments, void 0, function* (urlWithQueryParams, api = exports.ApiType.WMS, fallbackToWmsApi = false, overrideLayerConstructorParams, overrideGetMapParams) {
...
function legacyGetMapFromParams(baseUrl_1, wmsParams_1) {
    return __awaiter(this, arguments, void 0, function* (baseUrl, wmsParams, api = exports.ApiType.WMS, fallbackToWmsApi = false, overrideLayerConstructorParams, overrideGetMapParams, requestConfig, preferGetCapabilities = true) {
...
const retryRequests = (err) => {
    ...
    if (shouldRetry(err)) {
        ...
        if (shouldRetry) {
            ...
            err.config.transformRequest = [(data) => data];
...
exports.TPDICollections = void 0;
(function (TPDICollections) {
    ...
    TPDICollections["PLANETARY_VARIABLES"] = "PLANETARY_VARIABLES";
    TPDICollections["PLANET_ARPS"] = "PLANET_ARPS";
})(exports.TPDICollections || (exports.TPDICollections = {}));
exports.TPDProvider = void 0;
(function (TPDProvider) {
    TPDProvider["AIRBUS"] = "AIRBUS";
    TPDProvider["PLANET"] = "PLANET";
    TPDProvider["PLANETARY_VARIABLES"] = "PLANETARY_VARIABLES";
    TPDProvider["MAXAR"] = "MAXAR";
})(exports.TPDProvider || (exports.TPDProvider = {}));
exports.AirbusProcessingLevel = void 0;
...
exports.AirbusConstellation = void 0;
...
exports.PlanetProductBundle = void 0;
...
exports.PlanetARPSType = void 0;
(function (PlanetARPSType) {
    PlanetARPSType["AnalysisReadyPlanetScope"] = "analysis_ready_ps";
})(exports.PlanetARPSType || (exports.PlanetARPSType = {}));
exports.PlanetARPSId = void 0;
(function (PlanetARPSId) {
    PlanetARPSId["PS_ARD_SR_DAILY"] = "PS_ARD_SR_DAILY";
})(exports.PlanetARPSId || (exports.PlanetARPSId = {}));
exports.PlanetPVType = void 0;
(function (PlanetPVType) {
    PlanetPVType["BiomassProxy"] = "biomass_proxy";
    PlanetPVType["LandSurfaceTemperature"] = "land_surface_temperature";
    PlanetPVType["SoilWaterContent"] = "soil_water_content";
    PlanetPVType["ForestCarbonDiligence30m"] = "forest_carbon_diligence_30m";
    PlanetPVType["ForestCarbonMonitoring3m"] = "forest_carbon_monitoring_3m";
})(exports.PlanetPVType || (exports.PlanetPVType = {}));
exports.PlanetPVId = void 0;
(function (PlanetPVId) {
    PlanetPVId["BIOMASS_PROXY_V4_0_10"] = "BIOMASS-PROXY_V4.0_10";
    PlanetPVId["LST_AMSR2_V1_0_100"] = "LST-AMSR2_V1.0_100";
    PlanetPVId["LST_AMSRE_V1_0_1000"] = "LST-AMSRE_V1.0_1000";
    PlanetPVId["LST_AMSR2_V1_0_1000"] = "LST-AMSR2_V1.0_1000";
    PlanetPVId["SWC_AMSR2_C_V1_0_100"] = "SWC-AMSR2-C_V1.0_100";
    PlanetPVId["SWC_AMSR2_X_V1_0_100"] = "SWC-AMSR2-X_V1.0_100";
    PlanetPVId["SWC_SMAP_L_V1_0_100"] = "SWC-SMAP-L_V1.0_100";
    PlanetPVId["SWC_AMSR2_C_V2_0_100"] = "SWC-AMSR2-C_V2.0_100";
    PlanetPVId["SWC_AMSR2_X_V2_0_100"] = "SWC-AMSR2-X_V2.0_100";
    PlanetPVId["SWC_SMAP_L_V2_0_100"] = "SWC-SMAP-L_V2.0_100";
    PlanetPVId["SWC_AMSRE_C_V4_0_1000"] = "SWC-AMSRE-C_V4.0_1000";
    PlanetPVId["SWC_AMSRE_X_V4_0_1000"] = "SWC-AMSRE-X_V4.0_1000";
    PlanetPVId["SWC_AMSR2_C_V4_0_1000"] = "SWC-AMSR2-C_V4.0_1000";
    PlanetPVId["SWC_AMSR2_X_V4_0_1000"] = "SWC-AMSR2-X_V4.0_1000";
    PlanetPVId["SWC_SMAP_L_V4_0_1000"] = "SWC-SMAP-L_V4.0_1000";
    PlanetPVId["SWC_AMSRE_C_V5_0_1000"] = "SWC-AMSRE-C_V5.0_1000";
    PlanetPVId["SWC_AMSRE_X_V5_0_1000"] = "SWC-AMSRE-X_V5.0_1000";
    PlanetPVId["SWC_AMSR2_C_V5_0_1000"] = "SWC-AMSR2-C_V5.0_1000";
    PlanetPVId["SWC_AMSR2_X_V5_0_1000"] = "SWC-AMSR2-X_V5.0_1000";
    PlanetPVId["SWC_SMAP_L_V5_0_1000"] = "SWC-SMAP-L_V5.0_1000";
    PlanetPVId["CANOPY_HEIGHT_V1_1_0_30"] = "CANOPY_HEIGHT_v1.1.0_30";
    PlanetPVId["CANOPY_COVER_V1_1_0_30"] = "CANOPY_COVER_v1.1.0_30";
    PlanetPVId["ABOVEGROUND_CARBON_DENSITY_V1_1_0_30"] = "ABOVEGROUND_CARBON_DENSITY_v1.1.0_30";
    PlanetPVId["CANOPY_HEIGHT_V1_2_0_30"] = "CANOPY_HEIGHT_v1.2.0_30";
    PlanetPVId["CANOPY_COVER_V1_2_0_30"] = "CANOPY_COVER_v1.2.0_30";
    PlanetPVId["ABOVEGROUND_CARBON_DENSITY_V1_2_0_30"] = "ABOVEGROUND_CARBON_DENSITY_v1.2.0_30";
    PlanetPVId["CANOPY_HEIGHT_V1_0_0_3"] = "CANOPY_HEIGHT_v1.0.0_3";
    PlanetPVId["CANOPY_COVER_V1_0_0_3"] = "CANOPY_COVER_v1.0.0_3";
    PlanetPVId["ABOVEGROUND_CARBON_DENSITY_V1_0_0_3"] = "ABOVEGROUND_CARBON_DENSITY_v1.0.0_3";
})(exports.PlanetPVId || (exports.PlanetPVId = {}));
const PlanetSupportedPVIds = {
    [exports.PlanetPVType.BiomassProxy]: [exports.PlanetPVId.BIOMASS_PROXY_V4_0_10],
    [exports.PlanetPVType.LandSurfaceTemperature]: [
        exports.PlanetPVId.LST_AMSR2_V1_0_100,
        exports.PlanetPVId.LST_AMSRE_V1_0_1000,
        exports.PlanetPVId.LST_AMSR2_V1_0_1000,
    ],
    [exports.PlanetPVType.SoilWaterContent]: [
        exports.PlanetPVId.SWC_AMSR2_C_V1_0_100,
        exports.PlanetPVId.SWC_AMSR2_X_V1_0_100,
        exports.PlanetPVId.SWC_SMAP_L_V1_0_100,
        exports.PlanetPVId.SWC_AMSR2_C_V2_0_100,
        exports.PlanetPVId.SWC_AMSR2_X_V2_0_100,
        exports.PlanetPVId.SWC_SMAP_L_V2_0_100,
        exports.PlanetPVId.SWC_AMSRE_C_V4_0_1000,
        exports.PlanetPVId.SWC_AMSRE_X_V4_0_1000,
        exports.PlanetPVId.SWC_AMSR2_C_V4_0_1000,
        exports.PlanetPVId.SWC_AMSR2_X_V4_0_1000,
        exports.PlanetPVId.SWC_SMAP_L_V4_0_1000,
        exports.PlanetPVId.SWC_AMSRE_C_V5_0_1000,
        exports.PlanetPVId.SWC_AMSRE_X_V5_0_1000,
        exports.PlanetPVId.SWC_AMSR2_C_V5_0_1000,
        exports.PlanetPVId.SWC_AMSR2_X_V5_0_1000,
        exports.PlanetPVId.SWC_SMAP_L_V5_0_1000,
    ],
    [exports.PlanetPVType.ForestCarbonDiligence30m]: [
        exports.PlanetPVId.CANOPY_HEIGHT_V1_1_0_30,
        exports.PlanetPVId.CANOPY_COVER_V1_1_0_30,
        exports.PlanetPVId.ABOVEGROUND_CARBON_DENSITY_V1_1_0_30,
        exports.PlanetPVId.CANOPY_HEIGHT_V1_2_0_30,
        exports.PlanetPVId.CANOPY_COVER_V1_2_0_30,
        exports.PlanetPVId.ABOVEGROUND_CARBON_DENSITY_V1_2_0_30,
    ],
    [exports.PlanetPVType.ForestCarbonMonitoring3m]: [
        exports.PlanetPVId.CANOPY_HEIGHT_V1_0_0_3,
        exports.PlanetPVId.CANOPY_COVER_V1_0_0_3,
        exports.PlanetPVId.ABOVEGROUND_CARBON_DENSITY_V1_0_0_3,
    ],
};
const MaxarProductBands = '4BB';
exports.TPDITransactionStatus = void 0;
...
exports.PlanetScopeHarmonization = void 0;
...
exports.ResamplingKernel = void 0;
...
exports.HLSConstellation = void 0;
...
class PlanetDataProvider extends AbstractTPDProvider {
    ...
    getCommonSearchParams(params) {
        const payload = super.getCommonSearchParams(params);
...
class PlanetaryVariablesDataProvider extends AbstractTPDProvider {
    constructor() {
        super();
        this.provider = exports.TPDProvider.PLANETARY_VARIABLES;
    }
    getSearchParamsProvider() {
        return exports.TPDProvider.PLANET;
    }
    getAdditionalSearchParams(params) {
        const data = {};
        if (!params.type) {
...
let TPDI_SERVICE_URL = 'https://services.sentinel-hub.com/api/v1/dataimport';
function setTPDIServiceBaseURL(baseurl) {
...
function getQuotasInner(TDPICollectionId, reqConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield axios.get(`${TPDI_SERVICE_URL}/accountquotas`, requestConfig);
...
class TPDI {
    ...
    static search(provider_1, params_1, reqConfig_1) {
        return __awaiter(this, arguments, void 0, function* (provider, params, reqConfig, count = 10, viewtoken = null) {
            return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                const requestConfig = createRequestConfig(innerReqConfig);
    ...
    static getThumbnail(collectionId, productId, planetApiKey, reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!collectionId) {
            ...
            return yield ensureTimeout((innerReqConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield axios.get(`${TPDI_SERVICE_URL}/collections/${collectionId}/products/${productId}/thumbnail?${params.toString()}`, requestConfig);
...
exports.DATASET_CDAS_DEM = DATASET_CDAS_DEM;
...
exports.DATASET_CDAS_S3OLCI = DATASET_CDAS_S3OLCI;
exports.DATASET_CDAS_S3OLCIL2 = DATASET_CDAS_S3OLCIL2;
exports.DATASET_CDAS_S3SLSTR = DATASET_CDAS_S3SLSTR;
exports.DATASET_CDAS_S3SYNERGYL2 = DATASET_CDAS_S3SYNERGYL2;
exports.DATASET_CDAS_S5PL2 = DATASET_CDAS_S5PL2;
...
exports.DEMCDASLayer = DEMCDASLayer;
...
exports.PlanetSupportedPVIds = PlanetSupportedPVIds;
...
exports.S3OLCICDASLayer = S3OLCICDASLayer;
exports.S3OLCIL2CDASLayer = S3OLCIL2CDASLayer;
exports.S3OLCILayer = S3OLCILayer;
exports.S3SLSTRCDASLayer = S3SLSTRCDASLayer;
exports.S3SLSTRLayer = S3SLSTRLayer;
exports.S3SYNL2CDASLayer = S3SYNL2CDASLayer;
exports.S5PL2CDASLayer = S5PL2CDASLayer;
...
exports.StatisticalApi = StatisticalApi;
...
exports.getStatisticsProvider = getStatisticsProvider;
...
exports.setTPDIServiceBaseURL = setTPDIServiceBaseURL;
