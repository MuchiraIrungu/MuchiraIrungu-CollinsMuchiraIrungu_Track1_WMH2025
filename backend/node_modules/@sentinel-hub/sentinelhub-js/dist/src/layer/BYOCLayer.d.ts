...
export declare class BYOCLayer extends AbstractSentinelHubV3Layer {
    ...
    shServiceRootUrl: string;
    lowResolutionCollectionId: string;
    lowResolutionMetersPerPixelThreshold: number;
    constructor({ instanceId, layerId, evalscript, evalscriptUrl, dataProduct, title, description, collectionId, locationId, subType, shServiceRootUrl, highlights, }: ConstructorParameters);
    ...
    _updateProcessingGetMapPayload(payload: ProcessingPayload, datasetSeqNo?: number, reqConfig?: RequestConfiguration, params?: GetMapParams): Promise<ProcessingPayload>;
    shouldUseLowResolutionCollection(bbox: BBox, width: number): boolean;
