...
import { ApiType, DataProductId, FindTilesAdditionalParameters, GetMapParams, GetStatsParams, Interpolator, Link, MosaickingOrder, PaginatedTiles, Stats, Highlight } from './const';
...
export declare class AbstractSentinelHubV3Layer extends AbstractLayer {
    ...
    downsampling: Interpolator | null;
    highlights?: Highlight[] | null;
    constructor({ instanceId, layerId, evalscript, evalscriptUrl, dataProduct, mosaickingOrder, title, description, upsampling, downsampling, legendUrl, highlights, }: ConstructorParameters);
    getLayerId(): string;
    ...
    params?: GetMapParams): Promise<ProcessingPayload>;
