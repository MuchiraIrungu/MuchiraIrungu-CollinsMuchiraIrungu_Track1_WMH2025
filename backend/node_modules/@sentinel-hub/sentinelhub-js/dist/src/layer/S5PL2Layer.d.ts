...
export declare class S5PL2Layer extends AbstractSentinelHubV3Layer {
    ...
    minQa: number | null;
    constructor({ instanceId, layerId, evalscript, evalscriptUrl, dataProduct, title, description, legendUrl, productType, maxCloudCoverPercent, minQa, highlights, }: ConstructorParameters);
