...
export type MimeType = 'application/json' | 'text/xml' | 'image/png' | 'image/jpeg' | 'image/tiff' | 'image/tiff;depth=8' | 'image/tiff;depth=16' | 'image/tiff;depth=32f';
...
export declare const SH_SERVICE_ROOT_URL: {
    default: string;
    cdse: string;
    cdseOtc: string;
};
...
export declare const EQUATOR_RADIUS = 6378137;
export declare const DEGREE_TO_RADIAN: number;
export declare const RADIAN_TO_DEGREE: number;
export declare const XmlParserOptions: Readonly<{
    attributesGroupName: "$";
    attributeNamePrefix: "";
    textNodeName: "_";
