...
import { BackscatterCoeff, DEMInstanceTypeOrthorectification, PaginatedTiles, OrbitDirection, Link, DataProductId, FindTilesAdditionalParameters, MosaickingOrder } from './const';
...
export declare class S1GRDAWSEULayer extends AbstractSentinelHubV3Layer {
    ...
    backscatterCoeff: BackscatterCoeff | null;
    speckleFilter: SpeckleFilter | null;
    constructor({ instanceId, layerId, evalscript, evalscriptUrl, dataProduct, title, description, legendUrl, acquisitionMode, polarization, resolution, orthorectify, demInstanceType, backscatterCoeff, orbitDirection, speckleFilter, mosaickingOrder, highlights, }: ConstructorParameters);
