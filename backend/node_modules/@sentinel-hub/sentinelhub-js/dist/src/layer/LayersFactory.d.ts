...
export declare class LayersFactory {
    ...
    static makeLayers(baseUrl: string, filterLayers?: Function | null, overrideConstructorParams?: Record<string, any> | null, reqConfig?: RequestConfiguration, preferGetCapabilities?: boolean, includeHighlights?: boolean): Promise<AbstractLayer[]>;
